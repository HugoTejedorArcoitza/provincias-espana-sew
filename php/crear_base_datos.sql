...
CREATE TABLE IF NOT EXISTS Cliente (
    ...
    clave_cli VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS reservas (
    ...
    CONSTRAINT fk_reservas_cliente FOREIGN KEY (id_cli) REFERENCES Cliente(id_cli),
...
(1, 1, 'Sevilla Monumental y Triana', 'Ruta guiada por el Alcazar, la Catedral, el rio y Triana.', 25, '2026-05-02 10:00:00', '2026-05-02 14:00:00', 18.00),
...
(4, 4, 'Mirador urbano de Sevilla', 'Entrada a mirador con explicacion panoramica de la ciudad.', 40, '2026-05-05 19:00:00', '2026-05-05 20:00:00', 12.00),
(5, 3, 'Degustacion de tapas sevillanas', 'Menu degustacion con platos tipicos de Sevilla.', 35, '2026-05-06 13:30:00', '2026-05-06 15:00:00', 28.00);
